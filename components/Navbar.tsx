      ...
      items: [
        {
          label: "Sales Orders",
          href: "/sales/orders",
          desc: "Customer Quotations & SOs",
        },
        {
          label: "Customer Invoices",
          href: "/sales/invoices",
          desc: "Receivables & AR Invoices",
        },
      ],
    },
    {
      ...
      items: [
        {
          ...
          desc: "Vendor POs & Ordering",
        },
        {
          label: "Vendor Bills",
          href: "/purchase/bills",
          desc: "Payables & AP Bills",
        },
      ],
    },
    {
      ...
      items: [
        {
          label: "Payments",
          href: "/payments",
          desc: "Customer & Vendor Payments",
        },
        {
          label: "Journal Entries",
          href: "/entries",
          desc: "General Ledger Posting",
        },
        {
          label: "Chart of Accounts",
          href: "/masters/accounts",
          desc: "GL Account Hierarchy",
        },
      ],
    },
    {
      ...
      items: [
        {
          ...
          desc: "Items, Cost & Sales Prices",
        },
        {
          label: "Contacts",
          href: "/masters/contacts",
          desc: "Customers & Vendors List",
        },
        {
          label: "Journals",
          href: "/masters/journals",
          desc: "Sales, Purchase, Cash & Bank",
        },
        {
          label: "Analytic Accounts",
          href: "/masters/analytics",
          desc: "Cost Centers & Projects",
        },
      ],
    },
    {
      ...
      items: [
        ...
        },
        {
          ...
          href: "/reports/budget",
          desc: "Planned vs Actual Variance",
        },
        {
          label: "Budget Masters",
          href: "/masters/budgets",
          desc: "Budget Configurations",
        },
      ],
    },
  ];
